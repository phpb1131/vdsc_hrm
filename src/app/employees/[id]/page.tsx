          ...
          <Card>
            ...
            <Card.Body>
              <p className="text-muted">
                Nhân viên {employee.fullName} đã làm việc tại công ty từ ngày{" "}
                {formatDate(employee.hireDate)}. Hiện tại đang giữ chức vụ{" "}
                {employee.position} tại phòng ban {employee.department}.
              </p>
