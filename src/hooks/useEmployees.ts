...
interface UseEmployeesReturn {
    ...
    updateEmployee: (id: number, employee: EmployeeUpdateRequest) => Promise<void>;
...
export function useEmployees(options: UseEmployeesOptions = {}): UseEmployeesReturn {
    ...
    const createEmployee = useCallback(async (employee: EmployeeCreateRequest) => {
        try {
            setLoading(true);
            setError(null);
            ...
            const errorMessage = err instanceof Error ? err.message : 'Không thể tạo nhân viên mới';
            setError(errorMessage);
            throw err;
        } finally {
            setLoading(false);
    ...
    const updateEmployee = useCallback(async (id: number, employee: EmployeeUpdateRequest) => {
        try {
            setLoading(true);
            setError(null);
    ...
    const deleteEmployee = useCallback(async (id: number) => {
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : 'Không thể xóa nhân viên';
            setError(errorMessage);
            throw err;
        } finally {
            setLoading(false);
    ...
    const searchEmployees = useCallback(async (query: string) => {
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : 'Không thể tìm kiếm nhân viên';
            setError(errorMessage);
    ...
    const getEmployeeById = useCallback(async (id: number): Promise<Employee | null> => {
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : 'Không tìm thấy nhân viên';
            setError(errorMessage);
